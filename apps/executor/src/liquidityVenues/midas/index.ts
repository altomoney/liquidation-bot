...
export class MidasVenue implements LiquidityVenue {
  ...
  async convert(encoder: ExecutorEncoder, toConvert: ToConvert) {
    ...
    const previewRedeemInstantData =
      this.previewRedeemInstant(redemptionParams);
  ...
  private _getFeeAmount(params: PreviewRedeemInstantParams) {
    ...
    const fee = params.tokenOutConfig.fee + params.instantFee;
    const feePercent = fee > ONE_HUNDRED_PERCENT ? ONE_HUNDRED_PERCENT : fee;
  ...
  async getRedemptionParams(
    ...
    try {
      const [
        ...
        midasContract.read.dailyLimits([
