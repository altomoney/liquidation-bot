...
import {
  odosRethUsdcFixture,
  RETH_ODOS_FORK_BLOCK_NUMBER,
} from "@/test/fixtures/odosRethUsdc";
import {
...
beforeEach(() => {
  ...
  nock("https://api.odos.xyz")
    .post("/sor/quote/v3")
    .reply(200, odosRethUsdcFixture.quote);
  nock("https://api.odos.xyz")
    .post("/sor/assemble")
    .reply(200, odosRethUsdcFixture.assembled);
});

describe.sequential("rETH liquidation fork test", () => {
  executionTest(
