...
import {
  odosTbtcUsdcFixture,
  TBTC_ODOS_FORK_BLOCK_NUMBER,
} from "@/test/fixtures/odosTbtcUsdc";
import {
...
beforeEach(() => {
  ...
  nock("https://api.odos.xyz")
    .post("/sor/quote/v3")
    .reply(200, odosTbtcUsdcFixture.quote);
  nock("https://api.odos.xyz")
    .post("/sor/assemble")
    .reply(200, odosTbtcUsdcFixture.assembled);
});

describe.sequential("tBTC liquidation fork test", () => {
  executionTest(
