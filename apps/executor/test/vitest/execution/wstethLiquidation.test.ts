...
import {
  odosWstethUsdcFixture,
  WSTETH_ODOS_FORK_BLOCK_NUMBER,
} from "@/test/fixtures/odosWstethUsdc";
import {
...
beforeEach(() => {
  ...
  nock("https://api.odos.xyz")
    .post("/sor/quote/v3")
    .reply(200, odosWstethUsdcFixture.quote);
  nock("https://api.odos.xyz")
    .post("/sor/assemble")
    .reply(200, odosWstethUsdcFixture.assembled);
});

describe.sequential("wstETH liquidation fork test", () => {
  executionTest(
