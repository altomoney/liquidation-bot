...
import {
  odosPaxgUsdcFixture,
  PAXG_ODOS_FORK_BLOCK_NUMBER,
} from "@/test/fixtures/odosPaxgUsdc";
import {
...
beforeEach(() => {
  ...
  nock("https://api.odos.xyz")
    .post("/sor/quote/v3")
    .reply(200, odosPaxgUsdcFixture.quote);
  nock("https://api.odos.xyz")
    .post("/sor/assemble")
    .reply(200, odosPaxgUsdcFixture.assembled);
});

describe.sequential("PAXG liquidation fork test", () => {
  executionTest(
